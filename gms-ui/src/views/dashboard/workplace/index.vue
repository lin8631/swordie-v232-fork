      ...
      <a-row :gutter="[16, 16]">
        <a-col :span="6">
          <a-card class="stat-card" :bordered="false">
            <a-statistic
              :title="$t('workplace.onlinePlayers')"
        ...
        <a-col :span="6">
          <a-card class="stat-card" :bordered="false">
            <a-statistic
              :title="$t('workplace.serverVersion')"
              :value="Number(stats.serverVersion) || 0"
            />
          </a-card>
        </a-col>
        <a-col :span="6">
        ...
        <a-col :span="6">
          <a-card class="stat-card" :bordered="false">
            <a-statistic
              :title="$t('workplace.channelCount')"
...
<script lang="ts" setup>
  ...
  const dataReloadButtons = [
    ...
    { label: 'dataReloadMaps', action: 'reloadMaps', icon: 'icon-mind-mapping' },
    { label: 'dataReloadPortals', action: 'reloadPortals', icon: 'icon-common' },
  ];
